...
set extHDData=F:\Data

set logPath=C:\Data\Logs\ExternalHDD
...
IF NOT EXIST "%extHDData%" GOTO extHDDataNF
...
robocopy %logPath% F:\Data\Logs\ExternalHDD  /MIR /W:0 /R:1 /REG /TEE
